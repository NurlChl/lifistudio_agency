          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-lg border border-stone-200 bg-white text-stone-900 focus:outline-none focus:ring-2 focus:ring-accent-500 transition-all text-sm resize-none"
            ...
            >
              <div>
                ...
                <a
                  href={`https://wa.me/${(settings?.whatsappNumber || "6281234567890").replace(/[^\d]/g, "")}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#25D366] text-white text-sm font-semibold hover:bg-[#20BD5A] active:bg-[#1da851] active:scale-[0.97] transition-all duration-300"
                >
              ...
              <div className="pt-8 border-t border-stone-100">
                ...
                <div className="space-y-4 text-sm text-stone-600">
                  <p>
                    ...
                    {settings?.contactEmail || "hello@lifistudio.com"}
                  </p>
                  <p>
                    <strong className="text-stone-700">Location:</strong>{" "}
                    {settings?.address?.streetAddress
                      ? `${settings.address.streetAddress}, ${settings.address.addressLocality}, ${settings.address.addressRegion}, ${settings.address.addressCountry}`
                      : "Mojokerto, Jawa Timur, Indonesia"}
                  </p>
                  <p>
                    <strong className="text-stone-700">Jam Kerja:</strong>{" "}
                    {settings?.openingHours || "Sen - Sab, 08:00 - 17:00 WIB"}
                  </p>
                </div>
              </div>
            </motion.div>
